...
public class GD_HoaDon extends JFrame implements ActionListener, MouseListener {
	...
	public GD_HoaDon() {
		...
		panel.setBorder(new MatteBorder(5, 5, 5, 5, (Color) new Color(255,255,0)));
		...
		btnHuyHoaDon.setBackground(new Color(255,255,0));
		btnHuyHoaDon.setForeground(new Color(255,255,0));
		...
		btnHienTatCa.setForeground(new Color(255,255,0));
		...
		btnHienTatCaHDDaHuy.setForeground(new Color(255,255,0));
